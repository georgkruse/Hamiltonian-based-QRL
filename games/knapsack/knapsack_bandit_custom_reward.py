...
class KnapsackCUSTOM(gym.Env):
    def __init__(self,env_config):
        ...
        self.optimal_reward = self.calculate_reward(self.optimal_action)
    ...
    def calculate_reward(self,action):
        ...
        if weight > self.maximum_weight:
            if self.reward_type == "constant":
                reward = self.optimal_reward * self.reward_scaling
            elif self.reward_type == "subtract":
                reward = reward - self.optimal_reward * self.reward_scaling
        return reward
