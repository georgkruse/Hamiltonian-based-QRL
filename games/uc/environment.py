...
class Env(object):
    ...
    def calculate_lost_load_cost(self, net_demand, disp, availability=None):
        ...
        # GK: added penalty for over-delivery 
        self.over_delivery_cost = max((np.sum(self.commitment*self.max_output) - net_demand)**2, 1)*self.dispatch_resolution*50
        return ens_cost 
    ...
    def _get_reward(self):
        ...
        operating_cost = self.fuel_cost + self.ens_cost + self.start_cost #+ self.over_delivery_cost
