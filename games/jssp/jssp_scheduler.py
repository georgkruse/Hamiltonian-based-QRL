...
def get_jss_H(job_dict, max_time, disable_till=None, disable_since=None, disabled_variables=None, lagrange_one_hot=2, lagrange_precedence=1, lagrange_share=1):
